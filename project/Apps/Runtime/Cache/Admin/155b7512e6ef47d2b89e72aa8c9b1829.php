  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href=""> <i class="icon-signal"></i> <span class="label label-important">10</span> 友情链接列表 </a> </li>
      </ul>
    </div>
  </div>
  ...
  <thead>
    <tr role="row">
      ...
      <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 162px;" aria-label="Engine version: activate to sort column ascending">
        <div class="DataTables_sort_wrapper">链接图片
...
<tbody role="alert" aria-live="polite" aria-relevant="all">
  <?php if(is_array($links)): $i = 0; $__LIST__ = $links;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeA odd">
          <td class="  sorting_1" style="text-align:center"><?php echo ($vo["id"]); ?></td>
          <td class=" " style="text-align:center"><?php echo ($vo["name"]); ?></td>
          <td class=" " style="text-align:center"><?php echo ($vo["url"]); ?></td>
          <td class="center " style="text-align:center"><img src="/project11-5/Public/<?php echo ($vo["pic"]); ?>" width="50px"></td>
          <td class="center " style="text-align:center">
            <a href="<?php echo U('Admin/Link/edit',array('id'=>$vo['id']));?>">
            <button class="btn btn-primary"><i class="icon-edit"></i>编辑</button></a>
            <a href="<?php echo U('Admin/Link/delete',array('id'=>$vo['id']));?>">
