...
<!-- <!--Action boxes-->
  ...
  <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form class="form-horizontal" method="post" action="<?php echo U('Admin/Quan/save');?>">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="title" data-color="#ffffff" value="<?php echo ($title); ?>" style="height:30px">
                <input type="hidden" name="id" value="<?php echo ($id); ?>">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label" >组用户</label>
              <div class="controls">
              <?php if(is_array($users)): foreach($users as $key=>$vo): ?><input type="checkbox" name="users[]" value="<?php echo ($vo["uid"]); ?>"
                <?php if($vo["have"] == 1): ?>checked onclick="return false;"<?php endif; ?>><?php echo ($vo["username"]); ?>
                <!-- <input type="checkbox" name="users[]" value="<?php echo ($vo["uid"]); ?>"><?php echo ($vo["username"]); ?> --><?php endforeach; endif; ?>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <?php if(is_array($rules)): foreach($rules as $key=>$vo): ?><label>
                  &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="rules[]" style="margin-top:-3px" value="<?php echo ($vo["id"]); ?>"<?php if($vo["have"] == 1): ?>checked<?php endif; ?>
                                        >
                   &nbsp;<?php echo ($vo["title"]); ?>
