...
<!-- <!--Action boxes-->
  ...
  <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form class="form-horizontal" method="post" action="<?php echo U('Admin/Infor/update');?>" enctype="multipart/form-data">
          	<input type="hidden" name="id" value="<?php echo ($info['id']); ?>">
            <div class="control-group">
              <label class="control-label">网站名</label>
              <div class="controls">
                <input type="text" name="name" class="colorpicker input-big span11"  data-color="#ffffff" value="<?php echo ($info['name']); ?>">
                <span class="help-block">请输入网站名</span> </div>
            </div>
            <div class="control-group">
              <label class="control-label">网站简介</label>
              <div class="controls">
                <input type="text" name="content" class="colorpicker input-big span11"  data-color="#ffffff" value="<?php echo ($info['content']); ?>">
                <span class="help-block">请输入网站简介</span> </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <br>
                <img src="/project11-5/Public/<?php echo ($info['pic']); ?>" width="50px">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">网站版权</label>
              <div class="controls">
                <input type="text" name="config" value="<?php echo ($info['config']); ?>" class="datepicker span11"  data-date-format="dd-mm-yyyy" data-date="01-02-2013">
