...
<!-- <!--Action boxes-->
  ...
  <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form class="form-horizontal" method="post" action="<?php echo U('Admin/User/update');?>" enctype="multipart/form-data">
          	<input type="hidden" name="id" value="<?php echo ($info['id']); ?>">
            <div class="control-group">
              <label class="control-label">用户名</label>
              <div class="controls">
                <input type="text" name="username" class="colorpicker input-big span11"  data-color="#ffffff" value="<?php echo ($info['username']); ?>">
                <span class="help-block">请输入用户名</span> </div>
            </div>
            <div class="control-group">
              <label class="control-label">密码</label>
              <div class="controls">
                <input type="password" name="password" class="colorpicker span11" data-color-format="rgba"  data-color="rgba(344,232,53,0.5)" value="<?php echo ($info['password']); ?>">
                <span class="help-block">请输入密码</span> </div>
            </div>
            <div class="control-group">
              <label class="control-label">年龄</label>
              <div class="controls">
                <input type="text" name="age" class="datepicker span11"  data-date-format="dd-mm-yyyy" data-date="01-02-2013" value="<?php echo ($info['age']); ?>">
                <span class="help-block">请输入年龄</span> </div>
            </div>
            <div class="control-group">
              <label class="control-label">性别</label>
              <div class="controls">
                <input type="radio" name="sex" value="男"<?php if($info['sex'] == 1): ?>checked<?php endif; ?>>男
                <input type="radio" name="sex" value="女" <?php if($info['sex'] == 0): ?>checked<?php endif; ?>>女
                <input type="radio" name="sex" value="保密"<?php if($info['sex'] == 2): ?>checked<?php endif; ?>>保密
                <span class="help-block">请输入性别</span> </div>
            </div>
            <div class="control-group">
              <label class="control-label">邮箱</label>
              <div class="controls">
                <input type="text" value="<?php echo ($info['email']); ?>" name="email" class="datepicker span11"  data-date-format="dd-mm-yyyy" data-date="01-02-2013">
                <span class="help-block">请输入邮箱</span> </div>
            </div>
            <div class="control-group">
              <label class="control-label">手机</label>
              <div class="controls">
                <input type="text" name="phone" value="<?php echo ($info['phone']); ?>" class="datepicker span11"  data-date-format="dd-mm-yyyy" data-date="01-02-2013">
                <span class="help-block">请输入手机</span> </div>
            </div>
            <div class="control-group">
              <label class="control-label">地址</label>
              <div class="controls">
                <input type="text" name="address" value="<?php echo ($info['address']); ?>" class="datepicker span11"  data-date-format="dd-mm-yyyy" data-date="01-02-2013">
            ...
            <div class="control-group">
              ...
              <div class="controls">
               <select name="level" id="">
                 <option value="初级vip会员"<?php if($info['level'] == 0): ?>selected<?php endif; ?>>初级vip会员</option>
                 <option value="中级vip会员"<?php if($info['level'] == 1): ?>selected<?php endif; ?>>中级vip会员</option>
                 <option value="高级vip会员"<?php if($info['level'] == 2): ?>selected<?php endif; ?>>高级vip会员</option>
               </select>
                <span class="help-block">请输入邮箱</span> </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
               <select name="status" id="">
                 <option value="关闭"<?php if($info['status'] == 0): ?>selected<?php endif; ?>>关闭</option>
                 <option value="开启"<?php if($info['status'] == 1): ?>selected<?php endif; ?>>开启</option>
               </select>
                <span class="help-block">请输入邮箱</span> </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <br>
                <img src="/project5-19/Public/<?php echo ($info['pic']); ?>" width="50px">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">借阅数量</label>
              <div class="controls">
                <input type="text" name="booknum" value="<?php echo ($info['booknum']); ?>" class="datepicker span11"  data-date-format="dd-mm-yyyy" data-date="01-02-2013">
