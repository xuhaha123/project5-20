  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href=""> <i class="icon-signal"></i> <span class="label label-important">10</span> 图书列表 </a> </li>
      </ul>
    </div>
  </div>
  <div class="widget-box">
  <form action="<?php echo U('Admin/Book/index');?>" method="get">
    <div class="widget-content nopadding">
     ...
     <!--  <label>Search: <input type="text" aria-controls="DataTables_Table_0"><button>搜索</button></label></label> -->
      ...
      <a href="<?php echo U('Admin/Book/add');?>" class="btn btn-primary" style="margin-top:-12px;margin-right:10px">添加图书</a></span>
  ...
  <thead>
    <tr role="row">
      ...
      <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 272px;" aria-label="Platform(s): activate to sort column ascending">
        <div class="DataTables_sort_wrapper">分类
            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span></div>
      </th>
      ...
      <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 300px;" aria-label="Engine version: activate to sort column ascending">
        <div class="DataTables_sort_wrapper">推荐
            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
        </div>
      <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 600px;" aria-label="Engine version: activate to sort column ascending">
...
<tbody role="alert" aria-live="polite" aria-relevant="all">
    ...
    <tr class="gradeA odd">
          <?php if(is_array($cates)): $i = 0; $__LIST__ = $cates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><td class="  sorting_1" style="text-align:center"><?php echo ($vo["id"]); ?></td>
          <td class=" " style="text-align:center"><?php echo ($vo["title"]); ?></td>
          <td class=" " style="text-align:center"><?php echo ($vo["name"]); ?></td>
          <td class="center " style="text-align:center"><?php echo ($vo["num"]); ?></td>
          <td class="center " style="text-align:center">
          <img src="/project5-19/Public/<?php echo ($vo["pic"]); ?>" width="50px">
          </td>
          <td class="center " style="text-align:center">
          <?php
 switch ($vo['b_status']) { case '0': echo '下线'; break; default: echo '上线'; break; } ?>
          </td>
          <td class="center " style="text-align:center">
          <?php
 $str = $vo['b_content']; $html = htmlspecialchars_decode($str); echo $html; ?>
          
          </td>
          <td class="center ">
            <a href="<?php echo U('Admin/Book/edit',array('id'=>$vo['id']));?>">
            <button class="btn btn-primary"><i class="icon-edit"></i>编辑</button></a>
            <a href="<?php echo U('Admin/Book/delete',array('id'=>$vo['id']));?>">
