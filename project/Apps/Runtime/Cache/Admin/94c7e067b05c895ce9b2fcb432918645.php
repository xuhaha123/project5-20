...
<!-- <!--Action boxes-->
  ...
  <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form class="form-horizontal" method="post" action="<?php echo U('Admin/Title/update');?>" enctype="multipart/form-data">
          	<input type="hidden" name="id" value="<?php echo ($in['id']); ?>">
            <div class="control-group">
              <label class="control-label">公告名</label>
              <div class="controls">
                <input type="text" name="title" value="<?php echo ($in['title']); ?>">
                <span class="help-block">请输入公告名</span> </div>
            </div>
            
            <div class="control-group">
              <label class="control-label">时间</label>
              <div class="controls">
                <input type="text" name="time" value="<?php echo date('Y-m-d H:i:s',time()); ?>">
            </div>
