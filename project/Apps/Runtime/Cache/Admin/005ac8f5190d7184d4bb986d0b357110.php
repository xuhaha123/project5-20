  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href=""> <i class="icon-signal"></i> <span class="label label-important">10</span> 管理员列表 </a> </li>
      </ul>
    </div>
  </div>
  <div class="widget-box">
  <form action="<?php echo U('Admin/Guser/index');?>" method="get">
...
<tbody role="alert" aria-live="polite" aria-relevant="all">
  <?php if(is_array($gusers)): $i = 0; $__LIST__ = $gusers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeA odd">
          ...
          <td class="center " style="text-align:center">
            <a href="<?php echo U('Admin/Guser/edit',array('id'=>$vo['id']));?>">
            <button class="btn btn-primary"><i class="icon-edit"></i>编辑</button></a>
            <a href="<?php echo U('Admin/Guser/delete',array('id'=>$vo['id']));?>">
