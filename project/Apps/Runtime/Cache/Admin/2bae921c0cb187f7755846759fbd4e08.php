  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href=""> <i class="icon-signal"></i> <span class="label label-important">10</span> 图书详情 </a> </li>
      </ul>
    </div>
  </div>
  <div class="widget-box">
  <form action="<?php echo U('Admin/Bookinfo/index');?>" method="get">
...
<tbody role="alert" aria-live="polite" aria-relevant="all">
  <?php if(is_array($books)): $i = 0; $__LIST__ = $books;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeA odd">
          <td class="  sorting_1" style="text-align:center"><?php echo ($vo["id"]); ?></td>
          <td class=" " style="text-align:center"><?php echo ($vo["title"]); ?></td>
          <td class=" " style="text-align:center"><img src="/project5-19/Public/<?php echo ($vo["pic"]); ?>" width="50px"></td>
          <td class="center ">
            <a href="<?php echo U('Admin/Bookinfo/add',array('id'=>$vo['id']));?>">
            <button class="btn btn-primary"><i class="icon-edit"></i>添加详情</button></a>
            <a href="<?php echo U('Admin/Bookinfo/see',array('id'=>$vo['id']));?>">
            <button class="btn btn-primary"><i class="icon-edit"></i>查看详情</button></a>
            <a href="<?php echo U('Admin/Bookinfo/edit',array('id'=>$vo['id']));?>">
            <button class="btn btn-primary"><i class="icon-edit"></i>编辑详情</button></a>
            <a href="<?php echo U('Admin/Bookinfo/delete',array('id'=>$vo['id']));?>">
