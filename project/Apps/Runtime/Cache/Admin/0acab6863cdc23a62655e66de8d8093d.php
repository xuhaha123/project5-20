...
<!-- <!--Action boxes-->
 ...
 <script type="text/javascript">
    ...
    <div class="widget-box">
      <form action="<?php echo U('Admin/Cate/Index');?>" method="get" id="mid">
         ...
         <!--   <label>Search: <input type="text" aria-controls="DataTables_Table_0"></label></button> -->
            ...
            <?php if(is_array($cates)): foreach($cates as $key=>$vo): ?><tr class="gradeA odd">
                  ...
                  <td class="center "><?php echo ($vo["path"]); ?></td>
                   <td class="center "><button class="bts"><?php echo ($vo["display"]); ?></button></td>
                  <td class="center ">
                    <a href="<?php echo U('Admin/Cate/edit',array('id'=>$vo['id']));?>">
        ...
        $(function(){
          ...
          //   // alert('qq');
          //   var url ="<?php echo U('Admin/Cate/delete');?>";
          //   var tr =$(this);
          //   $.ajax({
          //     url: url,
          //     type: 'get',
     ...
     // alert('aaa');
             ...
             // alert(tr);
             $.ajax({
               url:'<?php echo U("Admin/Cate/delete");?>',
               data:{id:i},
               type:'get',
               success:function(data){
                 if(data){
            ...
            if(a == '开启'){
                   $.ajax({
                    url:'<?php echo U("Admin/Cate/do_ajax");?>',
