...
<!-- <!--Action boxes-->
  ...
  <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form class="form-horizontal" method="post" action="<?php echo U('Admin/Guser/update');?>" enctype="multipart/form-data">
            ...
            <div class="control-group">
              ...
              <div class="controls">
               <select name="level" id="">
                 <option value="管理员"<?php if($info['level'] == 0): ?>selected<?php endif; ?>>管理员</option>
                 <option value="高级管理员"<?php if($info['level'] == 1): ?>selected<?php endif; ?>>高级管理员</option>
               </select>
