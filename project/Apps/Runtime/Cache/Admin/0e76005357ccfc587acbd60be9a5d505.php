  ...
  <div class="container-fluid">
    <div class="">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href=""> <i class="icon-signal"></i> <span class="label label-important">10</span> 评论回复 </a> </li>
      </ul>
    </div>
  </div>
     ...
     <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          ...
          <form class="form-horizontal" method="post" action="<?php echo U('Admin/Comm/update1');?>">
 
            
            <div class="control-group">
              <label class="control-label" ></label>
              <div class="controls">
                <input type="hidden" value="<?php echo ($info['id']); ?>" name="id" data-color="#ffffff">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label" >name</label>
              <div class="controls">
                <input type="text" value="<?php echo ($info['name']); ?>" name="name" data-color="#ffffff" readonly>
                </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <textarea name="context" readonly><?php echo ($info['context']); ?></textarea>
              </div>
            </div>
             ...
             <!-- <div class="control-group">
              ...
              <div class="controls">
                <input name="status" value="<?php echo ($res[0]['display']); ?>" readonly></input>
              </div>
            </div>
 -->
            <div class="control-group">
