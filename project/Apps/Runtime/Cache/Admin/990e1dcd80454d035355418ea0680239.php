...
<!-- <!--Action boxes-->
  ...
  <?php
 $id=$_GET['id']; $sql="select * from book  where id=".$id; $result=mysql_query($sql); $res = mysql_fetch_assoc($result); $b_path=$res['b_path']; $sqls="select * from cate where id=".$b_path; $results=mysql_query($sqls); $ress=mysql_fetch_assoc($results); ?>
  ...
  <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form class="form-horizontal" method="post" action="<?php echo U('Admin/Book/update');?>" enctype="multipart/form-data">
          	<input type="hidden" name="id" value="<?php echo ($res['id']); ?>">
            <div class="control-group">
              <label class="control-label" >选择分类</label>
              <div class="controls">
                <select name="b_path" class="form-control">
                    <option value="<?php echo ($res['b_path']); ?>"><?php echo ($ress['name']); ?></option>
                <?php if(is_array($cates)): foreach($cates as $key=>$vo): ?><option value="<?php echo ($vo["name"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                </select>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="title" class="colorpicker input-big span11"  data-color="#ffffff" value="<?php echo ($res['title']); ?>">
                <span class="help-block">请输入图书名</span> </div>
            </div>
            <div class="control-group">
              <label class="control-label">数量</label>
              <div class="controls">
                <input type="text" name="num" class="colorpicker span11" data-color-format="rgba"  data-color="rgba(344,232,53,0.5)" value="<?php echo ($res['num']); ?>">
            ...
            <div class="control-group">
              ...
              <div class="controls">
               <select name="b_status" id="">
                 <option value="1"<?php if($res['b_status'] == 1): ?>selected<?php endif; ?>>上线</option>
                 <option value="0"<?php if($res['b_status'] == 0): ?>selected<?php endif; ?>>下线</option>
               </select>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <br>
                <img src="/project5-19/Public/<?php echo ($res['pic']); ?>" width="50px">
              </div>
            </div>
            <div class="control-group">
              ...
              <script id="editor" name="b_content" type="text/plain" style="width:850px;height:150px;margin-left:200px">
                <?php
 $str = $res['b_content']; $html = htmlspecialchars_decode($str); echo $html; ?>
              </script>
            </div>
