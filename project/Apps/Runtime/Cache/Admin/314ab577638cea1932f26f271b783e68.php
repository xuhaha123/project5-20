  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href=""> <i class="icon-signal"></i> <span class="label label-important">10</span> 网站信息 </a> </li>
      </ul>
    </div>
  </div>
  <div class="widget-box">
  <form action="<?php echo U('Admin/Infor/index');?>" method="get">
  ...
  <thead>
    <tr role="row">
      ...
      <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 200px;" aria-label="Browser: activate to sort column ascending">
        <div class="DataTables_sort_wrapper">网站名
      ...
      <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 200px;" aria-label="Engine version: activate to sort column ascending">
        <div class="DataTables_sort_wrapper">网站简介
      ...
      <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 1200px;" aria-label="Engine version: activate to sort column ascending">
        <div class="DataTables_sort_wrapper">网站版权
            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
        </div>
      </th>
...
<tbody role="alert" aria-live="polite" aria-relevant="all">
  <?php if(is_array($infors)): $i = 0; $__LIST__ = $infors;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeA odd">
          <td class="  sorting_1" style="text-align:center"><?php echo ($vo["id"]); ?></td>
          <td class=" " style="text-align:center"><?php echo ($vo["name"]); ?></td>
          <td class=" " style="text-align:center"><?php echo ($vo["content"]); ?></td>
          <td class="center " style="text-align:center"><img src="/project11-5/Public/<?php echo ($vo["pic"]); ?>" width="50px"></td>
          <td class="center " style="text-align:center"><?php echo ($vo["config"]); ?></td>
          <td class="center " style="text-align:center">
            <a href="<?php echo U('Admin/Infor/edit',array('id'=>$vo['id']));?>">
            <button class="btn btn-primary"><i class="icon-edit"></i>编辑</button></a>
            <a href="<?php echo U('Admin/Infor/delete',array('id'=>$vo['id']));?>">
