...
<!-- <!--Action boxes-->
  ...
  <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form class="form-horizontal" method="post" action="<?php echo U('Admin/Jie/update');?>" enctype="multipart/form-data">
          	<input type="hidden" name="j_id" value="<?php echo ($info['j_id']); ?>">
            <div class="control-group">
              <label class="control-label">用户</label>
              <div class="controls">
                <input type="text" name="username" class="colorpicker input-big span11"  data-color="#ffffff" value="<?php echo ($info['username']); ?>" readonly>
               </div>
            </div>
            <div class="control-group">
              <label class="control-label">图书名</label>
              <div class="controls">
                <input type="text" name="book" class="colorpicker input-big span11"  data-color="#ffffff" value="<?php echo ($info['book']); ?>" readonly>
                </div>
            </div>
            <div class="control-group">
              <label class="control-label">图片</label>
              <div class="controls">
                <img src="/project5-19/Public/<?php echo ($info['bpic']); ?>" width="50px">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">归还时间</label>
              <div class="controls">
                <input type="text" name="htime" class="colorpicker input-big span11"  data-color="#ffffff" value="<?php echo ($info['htime']); ?>" readonly>
                </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
               <select name="j_status" id="">
                 <option value="1"<?php if($info['j_status'] == 1): ?>selected<?php endif; ?>>是</option>
                 <option value="0"<?php if($info['j_status'] == 0): ?>selected<?php endif; ?>>否</option>
               </select>
                <span class="help-block">请确认是否归还</span> </div>
            </div>
