...
<!-- <!--Action boxes-->
  ...
  <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form class="form-horizontal" method="post" action="<?php echo U('Admin/Quan/groupinsert');?>">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="title" data-color="#ffffff" style="height:20px">
                </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <?php if(is_array($res)): foreach($res as $key=>$vo): ?><label>
                  &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="rules[]" style="margin-top:-3px" value="<?php echo ($vo["id"]); ?>">
                   &nbsp;<?php echo ($vo["title"]); ?>
