  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href=""> <i class="icon-signal"></i> <span class="label label-important">10</span> 借阅列表 </a> </li>
      </ul>
    </div>
  </div>
  <div class="widget-box">
  <form action="<?php echo U('Admin/Jie/index');?>" method="get">
  ...
  <thead>
    <tr role="row">
      ...
      <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 162px;" aria-label="Engine version: activate to sort column ascending">
        <div class="DataTables_sort_wrapper">图片
            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
        </div>
      </th>
      <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 162px;" aria-label="Engine version: activate to sort column ascending">
        <div class="DataTables_sort_wrapper">借书时间
            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
        </div>
      </th>
      <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 162px;" aria-label="Engine version: activate to sort column ascending">
        <div class="DataTables_sort_wrapper">归还时间
            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
        </div>
      </th>
      <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 400px;" aria-label="Engine version: activate to sort column ascending">
        <div class="DataTables_sort_wrapper">借阅时间(s)
            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
        </div>
      </th>
      <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 300px;" aria-label="Engine version: activate to sort column ascending">
        <div class="DataTables_sort_wrapper">扣除积分
            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
        </div>
      </th>
      <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 300px;" aria-label="Engine version: activate to sort column ascending">
        <div class="DataTables_sort_wrapper">是否借阅
            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
        </div>
      </th>
      <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 300px;" aria-label="Engine version: activate to sort column ascending">
        <div class="DataTables_sort_wrapper">是否归还
            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
        </div>
      </th>
      <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 900px;" aria-label="Engine version: activate to sort column ascending">
...
<tbody role="alert" aria-live="polite" aria-relevant="all">
  <?php if(is_array($jies)): $i = 0; $__LIST__ = $jies;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeA odd">
          <td class="  sorting_1" style="text-align:center"><?php echo ($vo["j_id"]); ?></td>
          <td class=" " style="text-align:center"><?php echo ($vo["username"]); ?></td>
          <td class=" " style="text-align:center"><?php echo ($vo["book"]); ?></td>
          <td class=" " style="text-align:center"><?php echo ($vo["j_num"]); ?></td>
          <td class="center " style="text-align:center"><img src="/project5-19/Public/<?php echo ($vo["bpic"]); ?>" width="50px"></td>
          <td class="center " style="text-align:center"><?php echo ($vo["jtime"]); ?></td>
          <td class="center " style="text-align:center">
          <?php
 if(empty($vo['j_status'])){ echo ''; }else{ echo $vo['htime']; } ?>
          </td>
          <td class="center " style="text-align:center">
          <?php
 if($vo['i_j']=='0'){ echo ''; }else{ $a=$vo['jtime']; $b=strtotime($a); $m=(int)$b; $c=$vo['htime']; $d=strtotime($c); $n=(int)$d; $e=$n-$m; $D=floor($e/86400); $S=floor(($e-$D*86400)/3600); $F=floor(($e-$D*86400-$S*3600)/60); $M=$e-$D*86400-$S*3600-$F*60; echo $D.'天'.$S.'时'.$F.'分'.$M.'秒'; } ?>
          </td>
          <td class="center " style="text-align:center"><?php echo ($vo["S_jf"]); ?></td>
          <td class="center " style="text-align:center">
          <?php
 switch ($vo['i_j']) { case '0': echo '否'; break; default: echo '是'; break; } ?>
          </td>
          <td class="center " style="text-align:center">
          <?php
 switch ($vo['j_status']) { case '0': echo '否'; break; default: echo '是'; break; } ?>
          </td>
          <td class="center ">
            <a href="<?php echo U('Admin/Jie/edit',array('id'=>$vo['j_id']));?>">
            <button class="btn btn-primary"><i class="icon-edit"></i>编辑</button></a>
            <a href="<?php echo U('Admin/Jie/delete',array('id'=>$vo['j_id']));?>">
