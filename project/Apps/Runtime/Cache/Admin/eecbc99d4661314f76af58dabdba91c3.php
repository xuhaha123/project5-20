  ...
  <div class="container-fluid">
    <div class="">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href=""> <i class="icon-signal"></i> <span class="label label-important">10</span> 回复意见 </a> </li>
      </ul>
    </div>
  </div>
     ...
     <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          ...
          <form class="form-horizontal" method="post" action="<?php echo U('Admin/Sug/update1');?>">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <input type="hidden" value="<?php echo ($value["aid"]); ?>" name="aid" data-color="#ffffff">
            ...
            <div class="control-group">
              ...
              <input type="text" value="<?php echo ($value["username"]); ?>" name="name" data-color="#ffffff" readonly>
            ...
            <div class="control-group">
              ...
              <textarea name="context" readonly><?php echo ($value["context"]); ?></textarea>
