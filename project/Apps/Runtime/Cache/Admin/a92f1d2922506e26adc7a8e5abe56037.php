  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href=""> <i class="icon-signal"></i> <span class="label label-important">10</span> 用户列表 </a> </li>
      </ul>
    </div>
  </div>
  ...
  <thead>
    <tr role="row">
      ...
      <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 272px;" aria-label="Platform(s): activate to sort column ascending">
        <div class="DataTables_sort_wrapper">年龄
            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span></div>
      </th>
      <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 162px;" aria-label="Engine version: activate to sort column ascending">
        <div class="DataTables_sort_wrapper">性别
      ...
      <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 162px;" aria-label="Engine version: activate to sort column ascending">
        <div class="DataTables_sort_wrapper">手机
            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
        </div>
      </th>
      <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 400px;" aria-label="Engine version: activate to sort column ascending">
        <div class="DataTables_sort_wrapper">地址
            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
        </div>
      </th>
      <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 300px;" aria-label="Engine version: activate to sort column ascending">
        <div class="DataTables_sort_wrapper">等级
            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
        </div>
      </th>
      <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 300px;" aria-label="Engine version: activate to sort column ascending">
      ...
      <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 162px;" aria-label="Engine version: activate to sort column ascending">
        <div class="DataTables_sort_wrapper">头像
            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
        </div>
      </th>
      <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 200px;" aria-label="Engine version: activate to sort column ascending">
        <div class="DataTables_sort_wrapper">借阅数量
            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
        </div>
      </th>
...
<tbody role="alert" aria-live="polite" aria-relevant="all">
  <?php if(is_array($users)): $i = 0; $__LIST__ = $users;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeA odd">
          <td class="  sorting_1" style="text-align:center"><?php echo ($vo["id"]); ?></td>
          <td class=" " style="text-align:center"><?php echo ($vo["username"]); ?></td>
          <td class=" " style="text-align:center"><?php echo ($vo["age"]); ?></td>
          <td class="center " style="text-align:center"><?php echo ($vo["sex"]); ?></td>
          <td class="center " style="text-align:center"><?php echo ($vo["email"]); ?></td>
          <td class="center " style="text-align:center"><?php echo ($vo["phone"]); ?></td>
          <td class="center " style="text-align:center"><?php echo ($vo["address"]); ?></td>
          <td class="center " style="text-align:center"><?php echo ($vo["level"]); ?></td>
          <td class="center " style="text-align:center"><?php echo ($vo["status"]); ?></td>
          <td class="center " style="text-align:center"><img src="/project5-19/Public/<?php echo ($vo["pic"]); ?>" width="50px"></td>
          <td class="center " style="text-align:center"><?php echo ($vo["booknum"]); ?></td>
          <td class="center ">
            <a href="<?php echo U('Admin/User/edit',array('id'=>$vo['id']));?>">
            <button class="btn btn-primary"><i class="icon-edit"></i>编辑</button></a>
            <a href="<?php echo U('Admin/User/delete',array('id'=>$vo['id']));?>">
