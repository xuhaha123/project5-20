  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href=""> <i class="icon-signal"></i> <span class="label label-important">10</span> 轮播列表 </a> </li>
      </ul>
    </div>
  </div>
  <div class="widget-box">
  <form action="<?php echo U('Admin/Lunbo/index');?>" method="get">
  ...
  <thead>
    <tr role="row">
      ...
      <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 200px;" aria-label="Browser: activate to sort column ascending">
        <div class="DataTables_sort_wrapper">轮播名
      ...
      <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 162px;" aria-label="Engine version: activate to sort column ascending">
        <div class="DataTables_sort_wrapper">轮播图片
...
<tbody role="alert" aria-live="polite" aria-relevant="all">
  <?php if(is_array($lunbos)): $i = 0; $__LIST__ = $lunbos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeA odd">
          ...
          <td class="center " style="text-align:center">
            <a href="<?php echo U('Admin/Lunbo/edit',array('id'=>$vo['id']));?>">
            <button class="btn btn-primary"><i class="icon-edit"></i>编辑</button></a>
            <a href="<?php echo U('Admin/Lunbo/delete',array('id'=>$vo['id']));?>">
