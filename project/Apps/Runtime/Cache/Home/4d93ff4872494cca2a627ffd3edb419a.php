...
　			</h5>
		...
		　　 图书馆实行藏、借、阅一体化服务体系，实现检索、采访、编目、流通、期刊自动化管理，每周开放98个小时，全天24小时网络开放，读者可通过校园网实现电子资料的查询、阅读、下载和馆藏文献的检索、预约、续借等多功能服务。图书馆以“读者第一，服务至上”为服务宗旨，努力为学校师生和社会读者提供高效优质服务，除常规服务外，还为读者提供课题检索、文献传送等项目服务。图书馆在学校校企合作、“五位一体”办学模式指导下，努力探索社会化服务的新模式，新途径，在学校实训实习基地、企事业单位、农村、军营等开展各种文化服务活动。
			...
			<p>图书馆先后获国家文化部、省市各级荣誉称号10余项。目前，图书馆积极参与中国高等教育文献资源保障系统和省内高校的共建共享活动，努力把图书馆办成多层次、高品位、现代化的数字化图书馆。
					...
					<div class="abt_img1"><img src="/project5-19/Public/Home/images/w1.jpg" alt=""></div>
					<div class="abt_img2"><img src="/project5-19/Public/Home/images/w2.jpg" alt=""></div>
					<div class="clearfix"></div>
			</div>
		</div>
...
<div class="get-in-touch">
			<div class="container">
				...
				<form action="<?php echo U('Home/Advice/insert');?>" method="get">
					<h3>意见反馈</h3>					
					<input type="text" class="text" value="<?php echo ($_SESSION['username']); ?>" onfocus="this.value = '<?php echo ($_SESSION['username']); ?>';" onblur="if (this.value == '') {this.value = '用户名';}" name="username" placeholder="请输入用户名" readonly>
					
					<input type="text" class="text" value="<?php echo ($_SESSION['email']); ?>" placeholder="请输入email" readonly>

					<input type="text" value="<?php echo ($_SESSION['phone']); ?>" placeholder="请输入phone" readonly>
					
					<textarea onfocus="if(this.value == 'Your Message') this.value='';" onblur="if(this.value == '') this.value='你的建议';" placeholder="请输入建议" name="context">你的建议</textarea>
					<input type="submit" value="提交">
				</form>
				</div>
				<style>
			        *{margin:0;padding:0;}
			        dialog{display:block;width:300px;height:383px;border:1px solid gray;padding:10px;}
				...
				<div class="col-md-3 address">
					...
					<address>
						<p class="ddd">上海市,
						<p class="ddd">闸北区,</p>
						<p class="ddd">信息服务楼1188号.</p>
						<p class="phone ddd"><span>电话</span>: 88888</p>
						<span class="phone" style="margin-left:70px">E-mail : <a href="/project5-19/Public/Home/mail-to:example@mail.com">lamp@mail.com</a></span>
					</address>
				</div>
				        ...
				        <form  method="get">
				          <h3 >意见显示</h3>         
				        	...
				        	<dialog>
						      ...
						      <input type="text" class="text" value="<?php echo ($_SESSION['username']); ?>" onfocus="this.value = '<?php echo ($_SESSION['username']); ?>';" onblur="if (this.value == '') {this.value = '用户名';}" name="username" placeholder="请输入用户名" readonly><br><br>

							
								<input type="text" class="text" value="<?php echo ($_SESSION['email']); ?>" onfocus="this.value = '<?php echo ($advices["email"]); ?>';" onblur="if (this.value == '') {this.value = '<?php echo ($vo["email"]); ?>';}" name="e-mail"  placeholder="请输入email" readonly><br><br>

								<input type="text" value="<?php echo ($_SESSION['phone']); ?>" placeholder="请输入phone"  readonly><br><br>
								<textarea onfocus="if(this.value == 'Your Message') this.value='';" onblur="if(this.value == '') this.value='';" name="context" value="<?php echo ($vo["context"]); ?>" placeholder="请输入意见" disabled="true"><?php echo ($value["context"]); ?></textarea><br><br>
								<input class="myButton" value="意见显示" disabled="true"><br><br><br>
								<dt><textarea onfocus="if(this.value == 'Your Message') this.value='';" onblur="if(this.value == '') this.value='意见显示';" name="context" disabled="true" placeholder="意见显示"><?php echo ($value["reply"]); ?></textarea>
								</dt>
