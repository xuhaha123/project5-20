...
<div class="typrography">
  ...
  <div id="main-p">
      ...
      <div class="col-md-6 dal">
        <form action="<?php echo U('Home/User/insert');?>" method="get">
          <h3 style="color:black;margin-top:55px;">用户评论</h3> 
          <input type="hidden" name="book_id" value="<?php echo ($value["id"]); ?>">        
          用户名:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" class="text" value="<?php echo ($_SESSION['username']); ?>" onfocus="this.value = '<?php echo ($_SESSION['username']); ?>';" onblur="if (this.value == '') {this.value = '用户名';}" name="username" readonly>

          <br>书名:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" class="text" value="<?php echo ($value["book"]); ?>" onfocus="this.value = '<?php echo ($value["book"]); ?>';" onblur="if (this.value == '') {this.value = '<?php echo ($value["book"]); ?>';}" name="book" readonly>

          <br>借阅时间:&nbsp;&nbsp;&nbsp;<input type="text" class="text" value="<?php echo ($value["jtime"]); ?>" onfocus="this.value = '<?php echo ($value["jtime"]); ?>';" onblur="if (this.value == '') {this.value = '<?php echo ($value["jtime"]); ?>';}" name="jtime" readonly>
          <textarea onfocus="if(this.value == 'Your Message') this.value='';" onblur="if(this.value == '') this.value='你的评论';" name="context">你的评论</textarea>
          <input type="submit" value="提交">
          <!-- <a href="<?php echo U('Home/User/comment');?>"><input type="button" value="查看"></a> -->
